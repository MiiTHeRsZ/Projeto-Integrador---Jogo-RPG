...
public class Main {
    ...
    static boolean menu = true, play = false, menuAtk, sonicAtkS = false, frozenAtkS = false, enemyAtkS = false, block,
            faseIncompleta, primEntrada;
    static int tempo = 0, sleepTime, lifePlayer = 35, damagePlayer = 10, sonicAtk, sonicAtkCD, frozenAtk, frozenAtkCD,
            atkCD = 0, bossLife = 50, bossDamage = 10, bossLvl = 1, bossFrozen, turn, areaCenario;
            ...
            switch (areaCenario) {
                ...
                case 1:
                    ...
                    if (acaoJogador.equalsIgnoreCase("olhar")) {
                        ...
                        texting(history, 35);
                            ...
                            || acaoJogador.equalsIgnoreCase("janela")) {
                        areaCenario = 2;
                        primEntrada = true;
                        ...
                        texting(history, 35);
                    } else if (acaoJogador.equalsIgnoreCase("brinquedos") || acaoJogador.equalsIgnoreCase("brinquedo")
                            || acaoJogador.equalsIgnoreCase("escorregador")) {
                ...
                case 2:
                    ...
                    if (acaoJogador.equalsIgnoreCase("olhar")) {
                        ...
                        caminhoInvalido();
                    } else if (acaoJogador.equalsIgnoreCase("Computador") || acaoJogador.equalsIgnoreCase("Caixa")
                            || acaoJogador.equalsIgnoreCase("Interagir")) {
                ...
                case 1:
                    ...
                    if (acaoJogador.equalsIgnoreCase("olhar")) {
                        ...
                        texting(history, 35);
                            ...
                            || acaoJogador.equalsIgnoreCase("garagem") || acaoJogador.equalsIgnoreCase("passagem")) {
                        areaCenario = 2;
                        primEntrada = true;
                    } else if (acaoJogador.equalsIgnoreCase("Interagir")) {
                        interacaoInvalida();
                        ...
                        texting(history, 35);
                    } else if (acaoJogador.equalsIgnoreCase("roupas") || acaoJogador.equalsIgnoreCase("roupa")
                            || acaoJogador.equalsIgnoreCase("varal")) {
    ...
    static void fase3() throws InterruptedException { // BOSS FIGHT
        do {
            ...
            // Encontro com o Boss e início da boss fight - Transferido para o seletor de
            // fases.
            // BossFight();
            faseIncompleta = false;
        } while (faseIncompleta);
            ...
            switch (areaCenario) {
                ...
                case 1:
                    ...
                    if (acaoJogador.equalsIgnoreCase("olhar")) {
                        ...
                        texting(history, 35);
                    } else if (acaoJogador.equalsIgnoreCase("frente") || acaoJogador.equalsIgnoreCase("subir")
                            || acaoJogador.equalsIgnoreCase("escada") || acaoJogador.equalsIgnoreCase("escadaria")
                            || acaoJogador.equalsIgnoreCase("escadas")) {
                        areaCenario = 2;
                        primEntrada = true;
                    } else if (acaoJogador.equalsIgnoreCase("Interagir")) {
                        interacaoInvalida();
                        ...
                        texting(history, 35);
                    } else if (acaoJogador.equalsIgnoreCase("fotografia") || acaoJogador.equalsIgnoreCase("foto")
                            || acaoJogador.equalsIgnoreCase("quadro")) {
            ...
            switch (areaCenario) {
                ...
                case 1:
                    ...
                    if (acaoJogador.equalsIgnoreCase("olhar")) {
                        ...
                        texting(history, 35);
                    } else if (acaoJogador.equalsIgnoreCase("frente") || acaoJogador.equalsIgnoreCase("seguir")
                            || acaoJogador.equalsIgnoreCase("fitas") || acaoJogador.equalsIgnoreCase("fita")
                            || acaoJogador.equalsIgnoreCase("norte")) {
                        areaCenario = 2;
                        primEntrada = true;
                    } else if (acaoJogador.equalsIgnoreCase("Interagir")) {
                        interacaoInvalida();
                        ...
                        texting(history, 35);
                    } else if (acaoJogador.equalsIgnoreCase("túmulo") || acaoJogador.equalsIgnoreCase("tumulo")
                            || acaoJogador.equalsIgnoreCase("lápide") || acaoJogador.equalsIgnoreCase("lapide")) {
                ...
                case 1:
                    ...
                    if (acaoJogador.equalsIgnoreCase("olhar")) {
                        ...
                        texting(history, 35);
                            ...
                            || acaoJogador.equalsIgnoreCase("mesas") || acaoJogador.equalsIgnoreCase("mesa")
                            || acaoJogador.equalsIgnoreCase("caminho")) {
                        areaCenario = 2;
                        primEntrada = true;
                    } else if (acaoJogador.equalsIgnoreCase("Interagir")) {
                        interacaoInvalida();
                        ...
                        texting(history, 35);
                    } else if (acaoJogador.equalsIgnoreCase("lareira") || acaoJogador.equalsIgnoreCase("fogo")
                            || acaoJogador.equalsIgnoreCase("cinzas")) {
            ...
            switch (areaCenario) {
                ...
                case 1:
                    ...
                    if (acaoJogador.equalsIgnoreCase("olhar")) {
                        ...
                        texting(history, 35);
                    } else if (acaoJogador.equalsIgnoreCase("sul") || acaoJogador.equalsIgnoreCase("descer")
                            || acaoJogador.equalsIgnoreCase("seguir")) {
                        areaCenario = 2;
                        primEntrada = true;
                    } else if (acaoJogador.equalsIgnoreCase("Interagir")) {
                        interacaoInvalida();
                        ...
                        texting(history, 35);
                    } else if (acaoJogador.equalsIgnoreCase("janelas") || acaoJogador.equalsIgnoreCase("janela")
                            || acaoJogador.equalsIgnoreCase("reflexo") || acaoJogador.equalsIgnoreCase("reflexos")) {
                ...
                case 2:
                    ...
                    if (acaoJogador.equalsIgnoreCase("olhar")) {
                        ...
                        caminhoInvalido();
                    } else if (acaoJogador.equalsIgnoreCase("Computador")
                            || acaoJogador.equalsIgnoreCase("Computadores") || acaoJogador.equalsIgnoreCase("Caixa")
                            || acaoJogador.equalsIgnoreCase("Caixas") || acaoJogador.equalsIgnoreCase("Interagir")) {
                        faseIncompleta = false;
                    } else if (acaoJogador.equalsIgnoreCase("Voltar")) {
    ...
    static void quest1() throws InterruptedException {
        ...
        do {
            ...
            // informações antes de enviá-las ao processador ou à uma unidade de
            // armazenamento.\nB) Armazenar informações que são utilizadas com frequência
            // para agilizar processos repetitivos.\nC) Armazenar massas de dados
            // diversificados de maneira não volátil, para usos posteriores.\nD) Ser
            // utilizada como uma espécie de backup da memória principal, já que é mais
            // fácil trocar para memória secundária do que recarregar a principal.";
    ...
    // Imprime o texto de forma mais lenta, carácter por carácter, como se estivesse
                ...
                case "atacar":
                    ...
                    if (sonicAtkS && !frozenAtkS) {
                        do {
                            ...
                            texting(history, 15);
                            optionMenuAtk = input.nextLine();
                            if (optionMenuAtk.equalsIgnoreCase("Ataque Normal")
                                    || optionMenuAtk.equalsIgnoreCase("Ataque")
                                    || optionMenuAtk.equalsIgnoreCase("Atacar")) {
                                ...
                                if (sonicAtkCD == 0) {
                                    ...
                                    history = "Este ataque está em TEMPO DE REGARGA por mais " + sonicAtkCD
                                            + " turno(s).";
                                    texting(history, 15);
                                    menuAtk = false;
                                }
                    ...
                    // Texto pós-ataque
                    if (optionMenuAtk.equalsIgnoreCase("Ataque Normal") || optionMenuAtk.equalsIgnoreCase("Ataque")
                            || optionMenuAtk.equalsIgnoreCase("Atacar")) {
                        history = "\nAtaque certeiro, você causou " + damagePlayer
                                + " de dano ao Boss, ele atualmente está com " + bossLife + " pontos de vida!\n\n";
                        texting(history, 15);
                    } else if (optionMenuAtk.equalsIgnoreCase("Ataque Sonico")) {
                        history = "\nAtaque especial incrível, você causou " + sonicAtk
                                + " de dano ao Boss, e ele atualmente está com apenas " + bossLife
                                + " pontos de vida!\n\n";
                        texting(history, 15);
                    } else if (optionMenuAtk.equalsIgnoreCase("Ataque de Gelo")) {
                        history = "\nAtaque especial fantástico, você causou " + frozenAtk
                                + " de dano ao Boss, e ele atualmente está com apenas " + bossLife
                                + " pontos de vida e não atacará no próximo turno!\n\n";
                        texting(history, 15);
                    }
    ...
    // FINAIS - ATENÇÃO NÃO LEIA ALÉM DESTA LINHA, CASO CONTRÁRIO, VOCÊ VERÁ OS
    // TEXTOS REFERENTES AOS TRÊS POSSÍVEIS FINAIS DO JOGO.
